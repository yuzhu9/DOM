...
var div2 = dom.create("<div>hi</div>");
dom.append(div, div2);
var span1 = dom.create("<span></span>");
dom.after(div2, span1);
var p1 = dom.create('<p></p>');
dom.before(div2, p1);
var section1 = dom.create('<section></section>');
var div4 = dom.create('<div></div>');
dom.append(div, section1);
dom.wrap(div, div4);
dom.remove(section1); // dom.empty(div4)
